...
class APIClient:
    ...
    async def _handle_response(self, response) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": f"Failed to parse response: {str(e)}", "success": False, "status_code": response.status}

    # Markdown operations
    async def create_markdown(self, filename: str, content: str = "") -> Dict[str, Any]:
        return await self.make_request("POST", "/markdown/create", {"filename": filename, "content": content})
    ...
    async def update_markdown(self, filename: str, content: str) -> Dict[str, Any]:
        return await self.make_request("PUT", f"/markdown/{filename}", {"content": content})
    ...
    async def git_merge(self, branch_name: str, allow_conflicts: bool = True) -> Dict[str, Any]:
        return await self.make_request(
            "POST", "/git/merge", {"branch_name": branch_name, "allow_conflicts": allow_conflicts}
        )

    async def git_create_branch(self, branch_name: str) -> Dict[str, Any]:
        return await self.make_request("POST", "/git/branch", {"branch_name": branch_name})
    ...
    async def git_checkout(self, branch_name: str) -> Dict[str, Any]:
        return await self.make_request("POST", "/git/checkout", {"branch_name": branch_name})
